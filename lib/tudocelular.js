...
searchPhone('Iphone 14 pro').then(async res => {
    if(res.length < 1) return
    getInfoPhone(res[0].url)
})

const getInfoPhone = async (url) => {
    return new Promise(async (resolve, reject) => {
